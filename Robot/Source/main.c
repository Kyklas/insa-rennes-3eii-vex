/**
 * \file main.c
 * \brief Fichier contenant la fonction main du projet - Fournis par Vex - Ne pas modifier 
		  Appel la routine ou est execute notre code
 * \author Vex Robotics
 */ 
...
#define ENABLE_AUTONOMOUS_MODE   1
