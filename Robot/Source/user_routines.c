 ...
 * \brief Fichier contenant certaines initialisations - Fournis par Vex 
 * \author Vex Robotics
 */ 
...
/**
 * \fn void User_Initialization (void)
 * \brief Fonction d'initialisation des broches d'E/S ainsi que des peripheriques du UC (port serie, Convertisseur A/N, etc.)
*/
